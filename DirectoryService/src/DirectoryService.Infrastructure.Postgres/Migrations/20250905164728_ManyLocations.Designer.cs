...
namespace DirectoryService.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20250905164728_ManyLocations")]
    partial class ManyLocations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DirectoryService.Domain.Departments.DepartmentLocation", b =>
                {
                    ...
                    b.ToTable("department_locations", null, t =>
                        {
                            t.Property("department_id")
                                .HasColumnName("department_id1");

                            t.Property("location_id")
            ...
            modelBuilder.Entity("DirectoryService.Domain.Positions.Position", b =>
                {
                    b.OwnsOne("DirectoryService.Domain.Positions.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("DirectoryService.Domain.Positions.Timezone", "Timezone", b1 =>
                        {
                            b1.Property<Guid>("PositionId")
                                .HasColumnType("uuid");
